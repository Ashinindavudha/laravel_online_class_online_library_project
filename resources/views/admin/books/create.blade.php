    ...
    <div class="card-body">
        <form method="POST" action="{{ route("books.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('call_number') ? 'is-invalid' : '' }}" type="text" name="call_number" id="call_number" value="{{ old('call_number', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('collation') ? 'is-invalid' : '' }}" type="text" name="collation" id="collation" value="{{ old('collation', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('isbn_issn') ? 'is-invalid' : '' }}" type="text" name="isbn_issn" id="isbn_issn" value="{{ old('isbn_issn', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('content_type') ? 'is-invalid' : '' }}" type="text" name="content_type" id="content_type" value="{{ old('content_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('media_type') ? 'is-invalid' : '' }}" type="text" name="media_type" id="media_type" value="{{ old('media_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('carrier_type') ? 'is-invalid' : '' }}" type="text" name="carrier_type" id="carrier_type" value="{{ old('carrier_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('specific_detail_info') ? 'is-invalid' : '' }}" type="text" name="specific_detail_info" id="specific_detail_info" value="{{ old('specific_detail_info', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('statement_responsibility') ? 'is-invalid' : '' }}" type="text" name="statement_responsibility" id="statement_responsibility" value="{{ old('statement_responsibility', '') }}">
